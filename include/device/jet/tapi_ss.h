...
#ifndef __DEVICE_JET_SS_H__
#define __DEVICE_JET_SS_H__

/**
 * All the TAPI SS context structures specific to Jet will be defined here.
 *
 * Values are identical to the Wave protocol definitions; the Jet modem uses
 * the same Mocha AP-CP TAPI SS opcodes.
 */
enum TAPI_SS_TYPE
{
